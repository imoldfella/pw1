...
namespace Boa.Constrictor.Playwright
{
    ...
    public class AddBrowserCookie : AbstractWebTask
    {
        ...
        private AddBrowserCookie(Datagrove.Playwright.Cookie cookie) => Cookie = cookie;
        ...
        /// </summary>
        private Datagrove.Playwright.Cookie Cookie { get; set; }
        ...
        /// <param name="cookie">The cookie to add to the WebDriver.</param>
        /// <returns></returns>
        public static AddBrowserCookie Named(Datagrove.Playwright.Cookie cookie) =>
        ...
        public static AddBrowserCookie Named(string name, string value) =>
            Named(new Datagrove.Playwright.Cookie(name, value));
